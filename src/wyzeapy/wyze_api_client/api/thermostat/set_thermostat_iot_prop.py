...
from ...models.set_thermostat_iot_prop_body import SetThermostatIotPropBody
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/plugin/earth/set_iot_prop_by_topic",
    }
...
def sync_detailed(
    *,
    ...
    """Set thermostat property

     Set a thermostat property value
