...
from ...models.set_wall_switch_iot_prop_body import SetWallSwitchIotPropBody
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/plugin/sirius/set_iot_prop_by_topic",
    }
...
def sync_detailed(
    *,
    ...
    """Set wall switch property

     Set a wall switch property value
