...
T = TypeVar("T", bound="GetPropertyListRequest")
...
class GetPropertyListRequest:
    ...
    Attributes:
        ...
        target_pid_list (list[str] | Unset):
    """
    ...
    target_pid_list: list[str] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        target_pid_list: list[str] | Unset = UNSET
        if not isinstance(self.target_pid_list, Unset):
            target_pid_list = self.target_pid_list
        ...
        if target_pid_list is not UNSET:
            field_dict["target_pid_list"] = target_pid_list
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        target_pid_list = cast(list[str], d.pop("target_pid_list", UNSET))

        get_property_list_request = cls(
            device_mac=device_mac,
            device_model=device_model,
        ...
        get_property_list_request.additional_properties = d
        return get_property_list_request
