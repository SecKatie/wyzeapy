...
@_attrs_define
class RunActionListRequest:
    """
    Attributes:
        action_list (list[RunActionListRequestActionListItem]):
    ...
    def to_dict(self) -> dict[str, Any]:
        action_list = []
        for action_list_item_data in self.action_list:
            action_list_item = action_list_item_data.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        run_action_list_request.additional_properties = d
        return run_action_list_request
