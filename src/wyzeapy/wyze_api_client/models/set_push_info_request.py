...
from ..models.set_push_info_request_push_switch import SetPushInfoRequestPushSwitch
from ..types import UNSET, Unset

T = TypeVar("T", bound="SetPushInfoRequest")


@_attrs_define
class SetPushInfoRequest:
    """
    Attributes:
        push_switch (SetPushInfoRequestPushSwitch): 1=enabled, 2=disabled
    ...
    push_switch: SetPushInfoRequestPushSwitch
    ...
    def to_dict(self) -> dict[str, Any]:
        push_switch = self.push_switch.value
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        push_switch = SetPushInfoRequestPushSwitch(d.pop("push_switch"))
        ...
        set_push_info_request.additional_properties = d
        return set_push_info_request
