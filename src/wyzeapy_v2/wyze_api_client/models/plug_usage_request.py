...
T = TypeVar("T", bound="PlugUsageRequest")


@_attrs_define
class PlugUsageRequest:
    """
    Attributes:
        device_mac (str):
        date_begin (int): Start timestamp in milliseconds
        date_end (int): End timestamp in milliseconds
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        date_begin = d.pop("date_begin")

        date_end = d.pop("date_end")
        ...
        plug_usage_request.additional_properties = d
        return plug_usage_request
