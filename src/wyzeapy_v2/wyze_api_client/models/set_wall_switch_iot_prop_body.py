...
if TYPE_CHECKING:
    from ..models.set_wall_switch_iot_prop_body_props import SetWallSwitchIotPropBodyProps


T = TypeVar("T", bound="SetWallSwitchIotPropBody")


@_attrs_define
class SetWallSwitchIotPropBody:
    """
    Attributes:
        did (str | Unset):
        model (str | Unset):
        props (SetWallSwitchIotPropBodyProps | Unset):
    ...
    props: SetWallSwitchIotPropBodyProps | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_props, Unset):
            ...
            props = SetWallSwitchIotPropBodyProps.from_dict(_props)

        is_sub_device = d.pop("is_sub_device", UNSET)

        nonce = d.pop("nonce", UNSET)

        set_wall_switch_iot_prop_body = cls(
            did=did,
            model=model,
            props=props,
        ...
        set_wall_switch_iot_prop_body.additional_properties = d
        return set_wall_switch_iot_prop_body
